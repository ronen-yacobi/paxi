...
package com.ryacobi.paxi.ui.bundle;

import android.content.Context;
import android.os.Bundle;
import android.text.TextUtils;
import android.util.Log;
import com.ryacobi.paxi.Constants;
...
public final class PluginBundleManager {
     ...
     */
    public static final String BUNDLE_EXTRA_STRING_HOST = "com.ryacobi.paxi.extra.HOST"; //$NON-NLS-1$
     ...
     */
    public static final String BUNDLE_EXTRA_INT_PORT = "com.ryacobi.paxi.extra.PORT"; //$NON-NLS-1$
     ...
     * Key for bundled data of a Port to send data to.
     */
    public static final String BUNDLE_EXTRA_STRING_PORT = "com.ryacobi.paxi.extra.PORT2"; //$NON-NLS-1$
     ...
     */
    public static final String BUNDLE_EXTRA_STRING_TEXT = "com.ryacobi.paxi.extra.TEXT"; //$NON-NLS-1$
     ...
     */
    public static final String BUNDLE_EXTRA_STRING_HEX = "com.ryacobi.paxi.extra.HEX"; //$NON-NLS-1$
     ...
     * Key for bundled data of hex data to send.
     */
    public static final String BUNDLE_EXTRA_BOOL_INPUTTEXT = "com.ryacobi.paxi.extra.INPUTTEXT"; //$NON-NLS-1$
    ...
    public static final String BUNDLE_EXTRA_INT_VERSION_CODE =
            "com.ryacobi.paxi.extra.INT_VERSION_CODE"; //$NON-NLS-1$
